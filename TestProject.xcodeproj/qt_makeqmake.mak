...
QMAKE    = /usr/bin/qmake
TestProject.xcodeproj/project.pbxproj: TestProject.pro  /usr/local/Qt4.8/mkspecs/macx-xcode/qmake.conf /usr/local/Qt4.8/mkspecs/common/unix.conf \
	...
	$(QMAKE) -spec /usr/local/Qt4.8/mkspecs/macx-xcode -o TestProject.xcodeproj/project.pbxproj TestProject.pro
